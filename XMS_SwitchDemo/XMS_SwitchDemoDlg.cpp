// XMS_SwitchDemoDlg.cpp : implementation file
//
...
CXMS_SwitchDemoDlg::CXMS_SwitchDemoDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CXMS_SwitchDemoDlg::IDD, pParent)
{
...
void CXMS_SwitchDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CXMS_SwitchDemoDlg, CDialog)
	//{{AFX_MSG_MAP(CXMS_SwitchDemoDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CXMS_SwitchDemoDlg message handlers

BOOL CXMS_SwitchDemoDlg::OnInitDialog()
{
...
void CXMS_SwitchDemoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CXMS_SwitchDemoDlg::OnPaint() 
{
	if (IsIconic())
	{
