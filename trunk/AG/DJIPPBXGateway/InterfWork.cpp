	...
	case XMS_EVT_CALLIN:	/*用户通道摘机事件*/// 20080506 USER底层修改后 无此事件
		{
			...
			//由于user连接语音资源异常，添加以下语句。。。
			pOneUser->VocDevID.m_CallID = g_AllDeviceRes[pOneUser->VocDevID.m_s8ModuleID].pVoice[pOneUser->VocDevID.m_s16ChannelID].deviceID.m_CallID;
